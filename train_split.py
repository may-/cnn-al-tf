...
def main(argv=None):
    ...
    # load context-split dataset
    train_data = util.read_data_contextwise(FLAGS.data_dir, 'train',  FLAGS.sent_len,
                                            negative=FLAGS.negative, hierarchical=FLAGS.hierarchical)
    test_data = util.read_data_contextwise(FLAGS.data_dir, 'dev', FLAGS.sent_len,
                                           negative=FLAGS.negative, hierarchical=FLAGS.hierarchical)
