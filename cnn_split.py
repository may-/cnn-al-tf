...
##########################################################
#
# Context-split CNN for Multi-label Text Classification
#
#
...
tf.app.flags.DEFINE_integer('sent_len', 100, 'Input sentence length.')
...
class Model(object):
    ...
    def build_graph(self):
        ...
        # conv + pooling layer
        contexts = []
        for contextwise_input, context in zip([input_left, input_right], ['left', 'right']):
        ...
        flat_context = tf.reshape(concat_context, [-1, pool_size*2])
        ...
        with tf.variable_scope('output') as scope:
            W, wd = _variable_with_weight_decay('W', shape=[pool_size*2, self.num_classes],
