...
tf.app.flags.DEFINE_integer('pool_size', 1000, 'Pool size. Must be greater than batch_size.')
tf.app.flags.DEFINE_string('strategy', 'model_change',
                           'Active learning strategy. Must be one of "max_entropy", "least_confident", "smallest_margin" and "model_change"')
...
# logging
tf.app.flags.DEFINE_integer('log_step', 10, 'Display log in stdout after this step')
            ...
            for _ in range(FLAGS.num_epochs):
                ...
                while len(indices) > 0:
                    ...
                    # last batch
                        ...
                        query_time.append((time.time() - start_time)/float(len(next_pool_idx)))
